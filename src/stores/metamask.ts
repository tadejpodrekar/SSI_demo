...
import type { VerifiableCredential, SelectedDID } from '../util/interfaces'
...
export const useMetamaskStore = defineStore('metamask', () => {
    ...
    const selectedDID = ref<SelectedDID | undefined>(undefined)
    const availableDIDs = ref<SelectedDID[] | undefined>(undefined);
